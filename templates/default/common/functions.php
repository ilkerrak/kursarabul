...
function getBookingSummary($room_id = null, $index = null, $amount = 0, $available = true)
{
    ...
    if($total > 0){
        ...
        <button name="book" id="btn-book_'.$hotel_id.'" class="btn color-bg btn-lg btn-block mt5"><b>'.$texts['TOTAL'].' '.formatPrice($total*CURRENCY_RATE).'</b> <i class="fas fa-fw fa-hand-point-right"></i> '.$texts['BOOK'].'</button>';
