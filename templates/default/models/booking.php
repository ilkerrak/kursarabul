                            ...
                            <div class="listing-item-container init-grid-items fl-wrap">
                                <div class="listing-item has_two_column has_one_column">
                                    ...
                                    <?php
                                        ...
                                        <a href="kurs-merkezleri/<?php echo $hotel_alias; ?>"><img src="<?php echo $thumbpath; ?>" alt="<?php echo $label; ?>"></a>
                                        <div class="listing-avatar"><a href="<?php echo $hotel_alias; ?>"><img src="<?php echo $thumbpath; ?>" alt="<?php echo $label; ?>"></a>
                                            <span class="avatar-tooltip"><strong><?php echo $label; ?></strong></span>
                                        </div>
                                        <?php
                                            }
                                        }       ?>
                                    ...
                                    <div class="geodir-category-content fl-wrap title-sin_item">
                                        <div class="geodir-category-content-title fl-wrap">
                                            <div class="geodir-category-content-title-item">
                                                <h3 class="title-sin_map"><a href="kurs-merkezleri/<?php echo $hotel_alias; ?>"> <?php echo $hotel_title; ?></a></h3>
                                        ...
                                        <?php
                                            ...
                                            <div class="geodir-category-price">fiyat <span><?php echo formatPrice($hotel_prices[$id_hotel]*CURRENCY_RATE); ?></span></div>
                                    ...
                                    <a href="#" data-target="#btn-collapse-<?php echo $id_hotel; ?>" class="btn color-bg btn-block mt10 anchor-toggle">
                                                <?php echo $texts['BOOK']; ?><i class="fal fa-caret-right"></i>
                                            </a>
                                </article>
                                                        ...
                                                        <div class="row room-result">
                                                            <div class="col-lg-6">
                                                                ...
                                                                if($result_room_file !== false && $db->last_row_count() > 0){
                                                                    ...
                                                                    if(is_file($realpath)){
                                                                        $s = getimagesize($realpath); ?>
                                                                        <div class="geodir-category-img" style="width:100% !important;" >
                                                            ...
                                                            <div class="<?php echo (SHOW_CALENDAR == 1) ? 'col-lg-2 col-md-3 col-sm-3' : 'col-lg-3 col-md-5 col-sm-5'; ?> text-center sep">
                                                                ...
                                                                if($room_stock > 0){ ?>
                                                                    <div class="pt10 form-inline">
                                                                        ...
                                                                        <select name="num_rooms[<?php echo $id_room; ?>]" class="chosen-select sendAjaxForm" data-target="#room-options-<?php echo $id_room; ?>" data-extratarget="#booking-amount_<?php echo $id_hotel; ?>" data-action="<?php echo getFromTemplate('common/change_num_rooms.php'); ?>?room=<?php echo $id_room; ?>">
                                                                            <?php
                                                                ...
                                                                <p class="lead">
                                                                    ...
                                                                    <a class="btn color-bg mt10 btn-block ajax-popup-link btn-sm" href="<?php echo getFromTemplate('common/room-popup.php', true); ?>" data-params="room=<?php echo $id_room; ?>">
			...
			for(var i = 0; i < num; i++){
				...
				'<div class="input-group input-group-sm">'+
					'<div class="input-group-addon"><?php echo ucfirst($texts['CHILD']); ?> '+(i+1)+'</div>'+
						'<select name="child_age['+attr[1]+']['+attr[2]+']['+i+']" class="chosen-select sendAjaxForm" data-extratarget="#'+extraTarget+'" data-action="<?php echo getFromTemplate('common/change_num_people.php'); ?>?index='+attr[2]+'&id_room='+attr[1]+'" data-target="#room-result-'+attr[1]+'-'+attr[2]+'" style="display: none;">'+
							'<option value="">-</option>';
