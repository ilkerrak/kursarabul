<?php
define('SITE_TITLE', 'Kurs Merkezi Rezervasyon');
...
define('OWNER', '');
define('EMAIL', 'info@edugineer.com');
define('ADDRESS', 'Yıldız Teknopark');
define('PHONE', '0212 444 00 44');
define('MOBILE', '0535 444 0 444');
define('FAX', '');
define('DB_NAME', 'kursmerkezi');
...
define('SMTP_PASS', '');
define('SMTP_PORT', '25');
define('GMAPS_API_KEY', 'AIzaSyC_dRXvweumOlfDtYgvWRN4_LYwNeNoExo');
...
define('CURRENCY_CONVERTER_KEY', 'info@ilkerak.com'); // currencyconverterapi.com API key
